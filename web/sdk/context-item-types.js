 ...
 * @property {HTMLElement} [customFormElement] - Custom form element rendered below the status row, indented to the badge column, in place of the default approval buttons
 */
