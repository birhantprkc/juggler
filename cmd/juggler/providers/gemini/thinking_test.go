...
func TestGeminiThinkingSpec(t *testing.T) {
	...
	for _, m := range []string{"models/gemini-2.0-flash", "models/gemini-1.5-pro"} {
		...
		if _, ok := spec.budgetFor("high"); ok {
